    ...
    return (
        <div className="home-full col-12 px-0">
            ...
            <div id="about" className="col-12 about-section">
                <div className="about-me-box col-12 col-md-11 mx-auto m-5">
            ...
            <div id="portfolio" className="col-12 portfolio-section mb-5 row mx-0">
                <h1 className="section-title text-center mt-5 mb-0 col-12">Recent Work!</h1>
                <div className="col-12 col-md-8 order-2 order-md-1 portfolio-full px-0">
                    <div className="col-12 portfolio-dots text-center">
                        . <br />
                    </div>
                    <div className="col-12 col-md-11 mx-auto indiv-portfolio-con px-0 row mx-0">
                        <div className="col-12 px-0 mt-5 row mx-0">
                            <div className="col-12 col-md-5 indiv-portfolio-image px-0">
                ...
                <div className="col-12 col-md-4 order-1 order-md-2 portfolio-astronaut">
                    <div className="col-12 portfolio-astronaut-con-1 mt-5">

                    </div>
                    <div className="col-12 portfolio-astronaut-con-2 mt-5">

                    </div>
                    <div className="col-12 portfolio-astronaut-con-3 mt-5">
            ...
            <div id="contact" className="contact-section col-12 mb-5">
                ...
                {/* <div className="col-9 mx-auto contact-con row mx-0">
                    <div className="col px-0 text-center indiv-contact">
                        <i class="fas fa-phone fa-lg my-3 p-3"></i>
